...
if (!(process.env.SESSION || process.env.SESSION_ID)) throw new Error("Raganork~d73d865e5d62d5e74e3f1de080fc5a35:465a584953682b417831303d")
module.exports = {
    VERSION: 'v4.0.0',
    ...
    SUDO: process.env.SUDO || "923048179418",
